...
class TaskListDetailView(APIView):
    def get(self, request, pk):
        ...
        try:
            ...
            try:
                ...
                return Response(
                    {"status": "error", "message": "Task list not found"},
                    status=status.HTTP_404_NOT_FOUND,
                )
    ...
    def patch(self, request, pk):
        ...
        try:
            ...
            if serializer.is_valid():
                ...
                room_name = "test_consumer_group"
                send_task_update_message(
                    room_name, {"message": "Task list updated", "data": serializer.data}
                )
                updated_serializer = TaskListSerializer(taskList)
                return Response(
                    {"status": "success", "data": updated_serializer.data},
                    status=status.HTTP_200_OK,
                )
            else:
                return Response(
    ...
    def delete(self, request, pk):
        ...
        try:
            ...
            room_name = "test_consumer_group"
            send_task_update_message(
                room_name, {"message": "Task list deleted", "task_list_id": pk}
            )
